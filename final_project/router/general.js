...
public_users.put("/review/:isbn", (req, res) => {
    ...
    if (book) {  // Check if friend exists
        ...
        books[isbn - 1] = book;  // Update friend details in 'friends' object
...
public_users.get('/author/:author',function (req, res) {
  ...
  let filtered_authors = books.filter((book) => book.author == author);
...
public_users.get('/review/:isbn',function (req, res) {
  //Write your code here
  const isbn = req.params.isbn;
  let filtered_review = books.filter((book) => book.isbn == isbn);
